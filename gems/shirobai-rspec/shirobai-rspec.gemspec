...
require_relative "lib/shirobai/rspec/version"

Gem::Specification.new do |spec|
  spec.name = "shirobai-rspec"
  spec.version = Shirobai::RSpec::VERSION
  spec.authors = ["fusagiko / takayamaki"]
  spec.summary = "Drop-in Rust replacement for rubocop-rspec cops"
  ...
  spec.add_dependency "shirobai", "= #{Shirobai::RSpec::VERSION}"

  # Hard pin, same policy as core's rubocop pin: shirobai copies cop
  # behavior at the byte level, so even a minor rubocop-rspec update
