...
require_relative "lib/shirobai/performance/version"

Gem::Specification.new do |spec|
  spec.name = "shirobai-performance"
  spec.version = Shirobai::Performance::VERSION
  spec.authors = ["fusagiko / takayamaki"]
  spec.summary = "Drop-in Rust replacement for rubocop-performance cops"
  ...
  spec.add_dependency "shirobai", "= #{Shirobai::Performance::VERSION}"
