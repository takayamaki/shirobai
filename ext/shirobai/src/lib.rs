...
/// 94 extra_spacing / 95 ordered_magic_comments /
/// 96 initial_indentation / 97 space_around_equals_in_parameter_default
///
...
fn check_all(ruby: &Ruby, source: RString, token: usize) -> Result<RArray, Error> {
    BUNDLE_CONFIGS.with(|cell| {
        ...
        ary.push(map_extra_spacing(r.extra_spacing))?; // slot 94
        // toucher-batch-1 core slots, renumbered to 95-97 after ExtraSpacing (94).
        ary.push(map_ordered_magic_comments(r.ordered_magic_comments))?; // slot 95
        ary.push(r.initial_indentation)?; // slot 96
